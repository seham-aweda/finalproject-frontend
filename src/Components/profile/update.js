...
React.useEffect(()=>{
    ...
    const updateUserInfo=()=>{
        ...
        axios.put('https://fit-at-home1.herokuapp.com/api/users/update/me',UserStrings,{headers:{
                'Authorization': localStorage.getItem('userToken')
            }}).then(res=>{
                console.log(res)
        }).catch(e=>console.log(e))
    ...
    const updateBmiInfo=()=>{
        ...
        axios.put('https://fit-at-home1.herokuapp.com/api/bmi/update',BMIStrings,{headers:{
                'Authorization': localStorage.getItem('userToken')
            }}).then(res=>{
            console.log(res)
        }).catch(e=>console.log(e))
        ...
        return (
            ...
            {console.log(updateBMI)}
                 ...
                 <ShowUser key={currUser._id} id={currUser._id} weight={currUser.bmi.weight} height={currUser.bmi.height}
                           ...
                           email={currUser.email} isActive={currUser.isActive}/>:<></>}
                 <Form>

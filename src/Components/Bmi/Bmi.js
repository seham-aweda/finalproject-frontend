                ...
                <div className={"ui container"}>
                    <div className="ui inverted segment">
                        <div className="ui inverted purple range" id="range-purple-inverted">
                            <input name={"height"} style={{width: "90%"}} type={'range'} min={"0"} max={'245'}
                                   step={"1"}
                    ...
                    <div className="ui inverted segment">
                        <div className="ui inverted purple range" id="range-purple-inverted">
                            <input name={"weight"} style={{width: "90%"}} type={'range'} min={"0"} max={'245'}
                                   step={"1"}
                    ...
                    <div style={{float: 'right'}}>
                        <button className="ui violet basic button" onClick={savingBMIToUser}>Continue</button>
                        <p>{note}</p></div>

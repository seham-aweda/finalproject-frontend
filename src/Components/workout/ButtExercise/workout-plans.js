...
export const buttAdvancedPlan = [
    {anim: highSteppingVideo, time: 30, exercise: 1, text: highStepping},
    {anim: rest, time: 8},
    {anim: donkeyKicksLeftVideo, time: '12times', exercise: 2, text: donkeyKicksLeft},
    {anim: rest, time: 8},
    {anim: donkeyKicksRightVideo, time: '12times', exercise: 3, text: donkeyKicksRight},
    {anim: rest, time: 15},
    {anim: crustyLungesVideo, time: '14times', exercise: 4, text: crustyLunges},
    {anim: rest, time: 15},
    {anim: leftLungeKneeHopsVideo, time: '12times', exercise: 5, text: leftLungeKneeHops},
    {anim: rest, time: 15},
    {anim: rightLungeKneeHopsVideo, time: '12times', exercise: 6, text: rightLungeKneeHops},
    {anim: rest, time: 15},
